<div class="card">
	<div class="card-header">
		<h5 class="card-title" id="mian_collect_fee">Create Sale</h5>
	</div>
	<div class="card-block">
		...
		<form action="inc/code2.php" method="POST" role="form" id="formData">
			...
			<br>
			<input type="hidden" class="editModule" name="insertORedit" value="">
			<input type="hidden" name="saleORpuchase" id="saleORpuchase" value="sale">
			<div class="form-group">
				<div class="row">
					<div class="col-sm-3">
						<label for="collect_sale_date">Date</label>
					</div>
					<div class="col-sm-9">
						<input type="text" class="form-control datepicker" value="<?=date('m/d/Y')?>" id="collect_sale_date" name="collect_sale_date">
					</div>
				</div>
			</div>
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-9">
						...
						<input list="lst" id="student_id" autocomplete="off" name="student_id" class="form-control">
							...
							<span class="input-group-append"><label class="input-group-text">Balance :<span id="student_previous"></span></label></span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-sm-12">
					<table class="table table-responsive" id="productTable">
						...
						<tbody>
							...
							<tr id="row<?=$x?>">
								<td>
									<input onchange="getProductData(<?=$x?>);" list="lst1" id="product_id<?=$x?>" autocomplete="off" name="product_id[]" class="form-control">
									<datalist id="lst1">	
								...
								<td>
									<input type="number" onkeyup="subTotalQty(<?=$x?>);" id="product_qty<?=$x?>" name="product_qty[]" class="form-control">
								</td>
								<td>
				...
				<div class="col-sm-12">				
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-9">
								<input type="text" name="purchase_paid" onkeyup="getPaidDueForSale();" id="purchase_paid" class="form-control">
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-9">
								<textarea name="purchase_naration" id="purchase_naration" class="form-control" rows="3"></textarea>
							</div>
						</div>
					</div>
				</div><!-- col -->
