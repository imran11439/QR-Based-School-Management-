<div class="card">
	<div class="card-header">
		<h5 class="card-title" id="mian_collect_fee">Edit Purchase</h5>
	</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-9">
						...
						<input list="lst" id="student_id" value="<?=$purchase['student_id']?>" autocomplete="off" name="student_id" class="form-control">
							<datalist id="lst">	
				...
				<div class="col-sm-12">				
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-9">
								<input type="text" name="purchase_paid" onkeyup="getPaidDueForSale();" value="<?=$purchase['purchase_paid']?>" id="purchase_paid" class="form-control">
							</div>
						</div>
					</div>
					<div class="form-group">
